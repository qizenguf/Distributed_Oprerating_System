...
import acl.ActorLogging

object example_bonus extends Application {
...
class pastryNode(pubKey:Int,Pa:Array[pastryNode],Boss:Actor,nodeID:String,numrequest:Int) extends ActorLogging {
    //val nodeID = "aa"
    //val pubKey= PubKey
    var status= "down";
...
class Boss(numNodes:Int, numrequest:Int) extends ActorLogging {
  def act{
     var sum = 0 ;
		 var n=0
  	 var readyNode = 0
